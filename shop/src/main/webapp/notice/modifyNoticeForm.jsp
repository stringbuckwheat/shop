...
<title>modify notice form</title>
	...
	<div class="container">
		...
		<div class="row">
		    <div class="col-md-8 col-md-offset-2 custyle">
			    <form action="<%=request.getContextPath()%>/notice/modifyNoticeAction.jsp" method="post">
			    	<input type="hidden" name="no" value="<%=noticeNo%>">
					<table class="table table-striped custab">
						<tr>
							<th>제목</th>
							<td>
								<input type="text" class="form-control" name="noticeTitle" value="<%=notice.getNoticeTitle()%>">
							</td>
						</tr>
						<tr>
							<th>내용</th>
